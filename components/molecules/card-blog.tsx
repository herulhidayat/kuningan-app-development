  ...
  return(
    <>
      <div className="flex flex-row gap-5 relative cursor-pointer" onMouseEnter={() => setShowAction(true)} onMouseLeave={() => setShowAction(false)}>
        <Image src={item?.image_cover ? `https://bigdata.kuningankab.go.id:9088/blog${item?.image_cover}` : "/img/placeholder-img.svg"} unoptimized alt="post-1" width={150} height={150} className="object-cover rounded-lg w-[150px] h-[150px]" />
