  ...
  return(
    <>
      <div className="flex flex-row gap-5 relative cursor-pointer" onMouseEnter={() => setShowAction(true)} onMouseLeave={() => setShowAction(false)}>
        <Image src={item?.image_cover ? `http://srv602602.hstgr.cloud:9088/blog${item?.image_cover}` : "/img/placeholder-img.svg"} alt="post-1" width={150} height={150} className="object-cover rounded-lg w-[150px] h-[150px]" />
