              ...
              <div className="flex flex-col justify-center items-start w-full">
                ...
                {item?.supporting_evidence && (
                  <div className="w-full flex justify-center items-center">
                      <Image src={`https://bigdata.kuningankab.go.id:9088/blog${item?.supporting_evidence}`} unoptimized alt="post-1" width={150} height={150} className="rounded-lg w-auto h-[150px]" />
                  </div>
                )}
