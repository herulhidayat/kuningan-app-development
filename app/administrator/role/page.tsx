            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex w-full justify-between">
                    ...
                    {access?.privillages?.add &&
                        <button className="text-gray-800 bg-primary-500 hover:bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm w-fit px-5 py-2.5 text-center dark:bg-primary-500 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={() => setModal((prev: any) => ({ ...prev, show: true, title: "Tambah Role" }))}>Tambah Role</button>
                    }
                </div>
